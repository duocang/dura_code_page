...
#### 1.4 Create Seurat object for every sample, with unique cell IDs ####
...
##### 2.2 Save QC Statistics before filtering (xlsx)  #####
...
##### 2.3 Visualization QC plots before filtering (PDF) #####
...
##### 3.2 Save QC Statistics after filtering (xlsx) #####
# Create a list to store QC data
qc_data_after <- list()
...
##### 3.3 Visualization QC plots after filtering (PDF) #####
...
#===== 7.0 cluster abundance changes - confounders adjusted =====
#### 7.1 data preparation with confounders ####
...
#### 7.2 CONFUNDERS adjusted pval & log2FC ####
...
#### 7.3 CONFUNDERS adjusted log2FC ####
run_propeller_with_confounders <- function(count_data, sample_data, group_var, confounders, comparisons, output_file) {
...
#===== 9.0 Reference dataset comparision =====
...
ggsave(file.path(result_dir, "9.0_stacked_barplots_references_allcells.pdf"), p , width = 23, height = 5)
...
##### 11.1.1 plotting top 5 marker genes #####
Idents(Bc_all_seurat) <- "seurat_clusters"
DefaultAssay(Bc_all_seurat) <- "SCT"
...
##### 11.4.1 find genes along pseudotime ####
#find genes that change in pseudotime
...
##### 11.4.2 plot genes of interest along pseudotime ####
#one can do multiple expression plots with certain identified genes
...
##### 11.4.3 plot top genes change over pseudotime ####
#plot top5 genes that change over pseudotime in each cluster
deg_sig <- deg %>% filter(q_value < 0.05, status == "OK")
...
ggsave(file.path(result_dir, "11.4.4_Bc_pseudotime_VolcanoPlot_DE_MS_vs_ctrl.pdf"), p , width = 10, height = 7)
...
ggsave(file.path(result_dir, "11.4.4_Bc_pseudotime_along_traj_Plot_DE_MS_vs_ctrl.pdf"), p , width = 5, height = 25)
...
ggsave(file.path(result_dir, "12.2_MzH_human_dura_IFN-induced_score_MS_vs_Ctrl_all_cluster.pdf"), p, width = 4, height = 6)

#### 12.3 correlation between scores ####
...
ggsave("12.3_Fibrosis_vs_IFN_per_patient_corelation_all_cluster.pdf", p, width = 8, height = 6)
...
ggsave("12.4_Fibrosis_vs_IFN_per_patient_density_PCA.pdf", p_marginal, width = 6, height = 6)
...
ggsave(file.path(result_dir, "13.4_neighborhoods_k80_cluster.pdf"), p, width = 8, heigh = 5)
...
p
ggsave(file.path(result_dir, "13.5_miloDE_AUC.pdf"), p, width = 5, heigh = 5)
...
ggsave(file.path(result_dir, "13.6_miloDE_all_corrected_across_genes.pdf"), p, width = 5, heigh = 5)
p <- plot_milo_by_single_metric(milo_k, stat_de_magnitude, colour_by = "n_DE_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# DE genes", limits = c(0, 55))
ggsave(file.path(result_dir, "13.6_miloDE_all_corrected_across_genes_max55.pdf"), p, width = 5, heigh = 5)
...
ggsave(file.path(result_dir, "13.6_miloDE_specific_all_corrected_across_nhoods.pdf"), p, width = 5, heigh = 5)

p <- plot_milo_by_single_metric(milo_k, stat_de_magnitude, colour_by = "n_specific_DE_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# specific\nDE genes" , option = "inferno", limits = c(0, 600))
ggsave(file.path(result_dir, "13.6_miloDE_specific_all_corrected_across_nhoods_max600.pdf"), p, width = 5, heigh = 5)
...
#### 13.7 miloDE upregulated in MS = pos LogFC####
...
p <- plot_milo_by_single_metric(milo_k, n_upregulated_per_nhood, colour_by = "n_upregulated_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# DE genes")
ggsave(file.path(result_dir, "13.7_miloDE_upregulated_MS_corrected_across_genes.pdf"), p, width = 5, heigh = 5)
...
ggsave(file.path(result_dir, "13.7_miloDE_upregulated_MS_corrected_across_nhoods.pdf"), p, width = 5, heigh = 5)

p <- plot_milo_by_single_metric(milo_k, n_specific_upregulated_per_nhood, colour_by = "n_upregulated_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# specific DE genes", limits = c(0, 400))
ggsave(file.path(result_dir, "13.7_miloDE_upregulated_MS_corrected_across_nhoods_max400.pdf"), p, width = 5, heigh = 5)

#### 13.8 miloDE downregulated in MS = neg LogFC####
## DE_corrected_across_genes
...
p <- plot_milo_by_single_metric(milo_k, n_downregulated_per_nhood, colour_by = "n_downregulated_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# DE genes")
ggsave(file.path(result_dir, "13.8_miloDE_downregulated_MS_corrected_across_genes.pdf"), p, width = 5, heigh = 5)
...
p <- plot_milo_by_single_metric(milo_k, n_specific_downregulated_per_nhood, colour_by = "n_downregulated_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# specific DE genes")
ggsave(file.path(result_dir, "13.8_miloDE_downregulated_MS_corrected_across_nhoods.pdf"), p, width = 5, heigh = 5)

p <- plot_milo_by_single_metric(milo_k, n_specific_downregulated_per_nhood, colour_by = "n_downregulated_genes" ,
                                layout = "UMAP" , size_range = c(1.5,3) , edge_width = c(0.2,0.5)) +
  scale_fill_viridis(name = "# specific DE genes", limits = c(0, 300))
ggsave(file.path(result_dir, "13.8_miloDE_downregulated_MS_corrected_across_nhoods_max300.pdf"), p, width = 5, heigh = 5)
...
ggsave(file.path(result_dir, "13.9_milo_DA_FDR_0.05_sig.pdf"), p, width = 5, heigh = 5)

p <- plotNhoodGraphDA(milo_k, milo_DA, alpha = 1)
ggsave(file.path(result_dir, "13.9_milo_DA_FDR_1_all.pdf"), p, width = 5, heigh = 5)

#==== 14.0 myeloid subsetten - reclustering - Fibro removed ====
...
ggsave(file.path(result_dir, "14.0_myeloid_subset_reclustering_restree.pdf"), tree, width = 10, height = 5)
...
ggsave(file.path(result_dir, "14.0_DimPlot_myeloid_reclustered_res0.07.pdf"), p, width = 6, height = 6)


p <- DimPlot(myeloid_seurat, label = T, split.by = "sample_id")
ggsave(file.path(result_dir, "14.0_DimPlot_myeloid_reclustered_res0.07_by_patient.pdf"), p, width = 30, height = 6)
...
##### 14.1.1 plotting top 5 marker genes #####
Idents(myeloid_main_seurat) <- "seurat_clusters"
DefaultAssay(myeloid_main_seurat) <- "SCT"
...
ggsave(file.path(result_dir, "14.1.1_DimPlot_myeloid_main_annotated.pdf"), p, width = 6, height = 6)

p <- DimPlot(myeloid_main_seurat, label = T, split.by = "condition")
ggsave(file.path(result_dir, "14.1.1_DimPlot_myeloid_main_annotated_Ms_vs_Ctrl.pdf"), p, width = 10, height = 6)

p <- DimPlot(myeloid_main_seurat, label = T, split.by = "sample_id")
ggsave(file.path(result_dir, "14.1.1_DimPlot_myeloid_main_annotated_by_patient.pdf"), p, width = 30, height = 6)
...
###### 14.4.1 find genes along pseudotime ####
#find genes that change in pseudotime
...
###### 14.4.2 plot genes of interest along pseudotime ####
#one can do multiple expression plots with certain identified genes
...
###### 14.4.3 plot top genes change over pseudotime ####
#plot top5 genes that change over pseudotime in each cluster
deg_sig <- deg %>% filter(q_value < 0.05, status == "OK")
...
#### 14.5 Trajectory monocle only 3 cluster ####
###### 14.5.0 pseudotime #####
#convert Seurat object into Monocle object
#integrated and SCT (slot = "scale.data") do not work as those are not saved as absolute values by Seurat but as differences from raw counts. So don't use scale.data
#best is to use "RNA", "counts"
...
###### 14.5.1 find genes along pseudotime ####
#find genes that change in pseudotime
deg <- graph_test(myeloid_monocle, neighbor_graph = "principal_graph", verbose = TRUE)
deg |> arrange(q_value, desc(morans_I)) |> filter(status == "OK") |> head()
...
###### 14.5.2 plot genes of interest along pseudotime ####
#one can do multiple expression plots with certain identified genes
...
###### 14.5.3 plot top genes change over pseudotime ####
#plot top5 genes that change over pseudotime in each cluster
deg_sig <- deg %>% filter(q_value < 0.05, status == "OK")
...
ggsave(file.path(result_dir, "14.5.4_myeloid_pseudotime_VolcanoPlot_DE_MS_vs_ctrl.pdf"), p , width = 10, height = 7)
...
ggsave(file.path(result_dir, "14.5.4_myeloid_pseudotime_along_traj_Plot_DE_MS_vs_ctrl.pdf"), p , width = 5, height = 25)

#### 14.6.0 cluster abundance changes - confounders adjusted ####
###### 14.6.1 data preparation with confounders #####
# Extract metadata and ensure all required variables are present
...
###### 14.6.2 CONFUNDERS adjusted pval & log2FC #####
run_propeller_with_confounders <- function(count_data, sample_data, group_var, confounders, comparisons, output_file) {
...
###### 14.6.3 CONFUNDERS adjusted log2FC #####
run_propeller_with_confounders <- function(count_data, sample_data, group_var, confounders, comparisons, output_file) {
...
tree <- clustree(res_check)
ggsave(file.path(result_dir, "15.0_Fibro_subset_reclustering_restree.pdf"), tree, width = 10, height = 5)
...
ggsave(file.path(result_dir, "15.0_DimPlot_Fibro_reclustered_res0.15.pdf"), p, width = 6, height = 6)

p <- DimPlot(Fibro_seurat, label = T, split.by = "sample_id")
ggsave(file.path(result_dir, "15.0_DimPlot_Fibro_reclustered_res0.15_by_patient.pdf"), p, width = 34, height = 6)
...
ggsave(file.path(result_dir, "15.0_DimPlot_Fibro_main_res0.15_removedClusters.pdf"), p, width = 6, height = 6)

p <- DimPlot(Fibro_main_seurat, label = T, split.by = "sample_id")
ggsave(file.path(result_dir, "15.0_DimPlot_Fibro_main_res0.15_removedClusters_by_patient.pdf"), p, width = 30, height = 6)
...
##### 15.2 GO on Fibro subset/reclustered #####
set.seed(42)
...
p <- DimPlot(Fibro_main_seurat, label = T)
ggsave(file.path(result_dir, "15.6_DimPlot_Fibro_main_with_annotated1.pdf"), p, width = 6, height = 6)

p <- DimPlot(Fibro_main_seurat, label = T, split.by = "annotated_1")
ggsave(file.path(result_dir, "15.6_DimPlot_Fibro_main_split.by_annotated1.pdf"), p, width = 20, height = 6)
...
ggsave(file.path(result_dir, "15.6_DimPlot_Fibro_reclustered_res0.15_newcolor.pdf"), p, width = 6, height = 6)
...
###### 15.7.1 find genes along pseudotime ####
#find genes that change in pseudotime
...
###### 15.7.2 plot genes of interest along pseudotime ####
#one can do multiple expression plots with certain identified genes
...
###### 15.7.3 plot top genes change over pseudotime ####
#plot top5 genes that change over pseudotime in each cluster
deg_sig <- deg %>% filter(q_value < 0.05, status == "OK")
...
ggsave(file.path(result_dir, "15.7.4_Fibro_pseudotime_VolcanoPlot_DE_MS_vs_ctrl.pdf"), p , width = 10, height = 7)
...
ggsave(file.path(result_dir, "15.7.4_Fibro_pseudotime_along_traj_Plot_DE_MS_vs_ctrl.pdf"), p , width = 5, height = 25)


##### 15.8 DE duraFibro overall ####
Idents(Fibro_main_seurat) <- "seurat_clusters"
...
##### 15.8.2 volcanoPlot duraFibro DE top DE genes label#####
...
##### 15.8.3 volcanoPlot duraFibro DE genes of interest label #####
de_file <- "15.8_DE_duraFibro_overall.xlsx"
...
###### 15.9.1 Visualization Circos plot ######
#top20
